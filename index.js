...
/*
   ...
   Footer
      ...
      - Links regaring Info of Company.     
*/
...
const Header = () => (
  <div className="header">
    <div className="logo-container">
      <img
        className="logo"
        src="https://cdn.pixabay.com/photo/2022/02/03/19/12/fork-6991173_1280.png"
        alt="tag"
      />
      {/* <h1>Namah Parvati Pateh Har Har Mahadev</h1> */}
    </div>
...
const Card = (props) => {
  ...
  return (
    <div className="card">
      <img 
        className="card-img"
        src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/45e128f5ffe26d93ac78b985e02c25eb"
        alt="Biryani-yum"
      />
      <h3>{props.dominozPizza.data.name}</h3>
      <h4>₹{props.dominozPizza.data.costForTwo / 100} FOR TWO</h4>
      <h4>{props.dominozPizza.data.avgRating} stars</h4>
      <h4>{props.dominozPizza.data.cuisines.join(",")}</h4>
      <h4>{props.dominozPizza.data.deliveryTime} minutes</h4>
    </div>
  );
};
  ...
  return (
    <div className="body-container">
      ...
      <div className="card-container">
        {/* <Card resName ="Meghna Food" cusine = "Biryani , North Indian , Asian"/>
        <Card resName ="KFC" cusine ="Burger , Fast food"/> */}

        {/* {console.log(DominozPizzaObj)} */}

        <Card dominozPizza = {DominozPizzaObj} />
      </div>
    </div>
  );
};
